        ...
        if self.validar_url_youtube(url_youtube):
            try:
                ...
                if audio:
                    ...
                    archivo_mp4 = os.path.join(self.current_folder, f"{video_title}.{audio.subtype}")
                    
                    archivo_mp4_ruta = os.path.join(self.current_folder, f"{video_title}.mp3")
                    ffmpeg.input(archivo_mp4).output(archivo_mp4_ruta, audio_bitrate="256k").run()
